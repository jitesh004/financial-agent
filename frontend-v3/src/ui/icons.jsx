/* ────────────────────────────────────────────────────────────────────────────
   Prism v3 Precision Icon Library
   Inline SVG icons drawn on a 24-unit grid with crisp 1.75 stroke and round joins.
   ──────────────────────────────────────────────────────────────────────── */
...
const P = {
  ...
  flame: 'M12 2c1 3 4 5 4 9a6 6 0 11-12 0c0-4 3-6 4-9z',
  brain: 'M9.5 4a3.5 3.5 0 00-3.5 3.5c0 .3.05.6.13.88A3.5 3.5 0 004 12c0 1.5.93 2.78 2.25 3.3.06.23.09.47.09.7a3.5 3.5 0 003.5 3.5c.9 0 1.7-.34 2.3-.9A3.5 3.5 0 0014.5 20c1.93 0 3.5-1.57 3.5-3.5 0-.23-.03-.47-.09-.7A3.5 3.5 0 0020 12a3.5 3.5 0 00-2.13-3.22c.08-.28.13-.58.13-.88A3.5 3.5 0 0014.5 4c-.9 0-1.7.34-2.3.9A3.5 3.5 0 009.5 4z',
...
export function Logo({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      <defs>
        <linearGradient id="p3-brand" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="var(--accent)" />
          <stop offset="50%" stopColor="#38bdf8" />
          <stop offset="100%" stopColor="var(--pos)" />
        </linearGradient>
      </defs>
      <path d="M16 3 L29 28 H3 Z" stroke="url(#p3-brand)" strokeWidth="2.6"
        strokeLinejoin="round" fill="none" />
      <path d="M2 17 H12" stroke="var(--text-3)" strokeWidth="2" strokeLinecap="round" />
      <path d="M20 13 H30" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" />
      <path d="M20 18 H30" stroke="#38bdf8" strokeWidth="2" strokeLinecap="round" />
      <path d="M20 23 H30" stroke="var(--pos)" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
